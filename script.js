...
fetchNasaBtn.addEventListener('click', () => {
    ...
    const finalImageUrl = `https://gibs.earthdata.nasa.gov/wms/epsg4326/best/wms.cgi?BBOX=${minLat},${minLon},${maxLat},${maxLon}&REQUEST=GetMap&FORMAT=image/jpeg&VERSION=1.3.0&LAYERS=BlueMarble_ShadedRelief_Bathymetry&WIDTH=600&HEIGHT=300&CRS=EPSG:4326`;
